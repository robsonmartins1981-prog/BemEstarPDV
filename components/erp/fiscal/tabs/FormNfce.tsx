...
const FormNfce: React.FC<FormNfceProps> = ({ data, onChange }) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <fieldset className="border p-4 rounded-md dark:border-gray-600">
                <legend className="text-md font-semibold px-2">CSC - Código de Segurança do Contribuinte</legend>
                 <p className="text-xs text-gray-500 dark:text-gray-400 mt-2 px-2">
                    Este token é fornecido pela SEFAZ do seu estado e é obrigatório para a emissão de NFC-e.
                </p>
