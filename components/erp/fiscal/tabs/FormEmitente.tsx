    ...
    return (
        <div className="space-y-4">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                {/* Endereço */}
                 <div className="md:col-span-2 border-t pt-4 mt-2 dark:border-gray-600 grid grid-cols-1 md:grid-cols-6 gap-x-6 gap-y-4">
                    ...
                    <div className="col-span-6 md:col-span-2">
                        <label className="block text-sm font-medium">Código IBGE da Cidade</label>
