...
import { CreditCard, Banknote, QrCode, User, Receipt, CheckCircle2, Plus, Trash2, Search } from 'lucide-react';
...
const PaymentModal: React.FC<PaymentModalProps> = ({ isOpen, onClose, totalAmount, onFinalize, selectedCustomer: initialCustomer }) => {
  ...
  }, [isOpen, totalAmount, initialCustomer]);
    ...
    <Modal
      ...
      footer={
        <div className="flex gap-4 w-full">
          ...
          <Button variant="primary" className="flex-1 py-6" onClick={handleConfirm} disabled={totalPaid < totalAmount}>
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-3xl border border-gray-100 dark:border-gray-800 flex justify-between items-center">
            <div>
              <p className="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-1">Total da Venda</p>
              <p className="text-3xl font-black text-gray-800 dark:text-white">{formatCurrency(totalAmount)}</p>
            </div>
            <div className="text-right">
              <p className="text-[10px] font-black uppercase text-theme-primary tracking-widest mb-1">Restante</p>
              <p className="text-3xl font-black text-theme-primary">{formatCurrency(remaining)}</p>
            </div>
          </div>
        ...
        <div className="space-y-6 flex flex-col">
          <div className="flex-grow bg-gray-50 dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 overflow-hidden flex flex-col">
