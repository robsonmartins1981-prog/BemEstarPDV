             ...
             <fieldset className="border p-3 md:p-4 rounded-md dark:border-gray-600">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                    <div className="md:col-span-2">
                        ...
                        <label htmlFor="cert-upload" className="flex items-center justify-center w-full px-4 py-4 md:py-6 text-center border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 hover:border-theme-primary dark:hover:border-theme-primary transition-colors cursor-pointer bg-gray-50 dark:bg-gray-700/50">
                            <div className="text-center">
                                <UploadCloud className="w-8 h-8 mx-auto text-gray-400 mb-2"/>
                                <span className="font-medium text-gray-700 dark:text-gray-300 block truncate max-w-[200px] md:max-w-none mx-auto">
                                    {certificateName ? `Arquivo: ${certificateName}` : 'Selecionar arquivo .pfx'}
                                </span>
                            </div>
